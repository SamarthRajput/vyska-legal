...
export default function HeroCarousel() {
    ...
    return (
        <div className="relative w-full">
                    ...
                    >
                        {slide.type === 'fullBackground' ? (
                            <div className={`h-full relative bg-gradient-to-br ${slide.bgColor}`}>
                                <div className="h-full flex items-center px-6 md:px-12 lg:px-16 py-8 md:py-12">
                                    <div className="text-white space-y-4 md:space-y-6 max-w-xl z-20">
                                        ...
                                        <Link href={slide.buttonLink}>
                                            <button className="bg-white text-gray-900 px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg text-sm md:text-base">
                                                {slide.buttonText}
                                            </button>
                                        </Link>
                                    </div>
                                ...
                                <div className="absolute right-0 bottom-0 w-[50%] md:w-[45%] lg:w-[40%] h-[60%] md:h-[70%] lg:h-[75%]">
                                    <Image
                                        src={slide.image}
                                        alt={slide.title}
                                        fill
                            ...
                            <div className={`h-full flex flex-col lg:flex-row bg-gradient-to-br ${slide.bgColor}`}>
                                <div className="w-full lg:w-1/2 flex items-center px-6 md:px-12 lg:px-16 py-8 md:py-12">
                                ...
                                <div 
                                    className="w-full lg:w-1/2 relative h-48 md:h-64 lg:h-full overflow-hidden"
                                    style={{
                        ...
                        <a
                            ...
                            className="absolute bottom-4 right-4 md:bottom-6 md:right-6 lg:bottom-8 lg:right-8 z-30 bg-green-500 hover:bg-green-600 p-3 md:p-4 rounded-full shadow-lg transition-colors"
            ...
            <div className="flex justify-center items-center py-4 md:py-6 bg-white">
